...
// Pi is absent from the default-model maps on purpose: its models are whatever
// the user's own `~/.pi` configuration authenticates, discovered live via the
// provider probe. `Partial` keeps every lookup optional.
